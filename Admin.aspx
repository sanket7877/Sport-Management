<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="SMS.Admin" %>
...
<marquee id="mar">WELCOME SPORTS WEEK 2K19</marquee>
    <form id="form1" runat="server">
      <div class="three d1">
          <asp:Button ID="Button2" runat="server" class="btn btn-light bu" Text="Profile" ForeColor="#03A9F4" />
</div>
...
<div class="re three d3">
    <asp:Button ID="LogOut" class="btn btn-light bu" runat="server" Text="LogOut" ForeColor="#03A9F4" />
</div>
            <div id="div">
                 <div class="form-group col-md-4">
                     <br />
               <asp:Button ID="gameWinner" runat="server" class="btn btn-light bu" Width="150px" Text="Game Winner" ForeColor="#03A9F4" />
               <asp:Button ID="Button2" runat="server" class="btn btn-light bu" width="150px" Text="Student" ForeColor="#03A9F4" />
               <asp:Button ID="facultyView" runat="server" class="btn btn-light bu" Width="150px" Text="Faculty" ForeColor="#03A9F4" />
 </div>
    </div>
 </form>
