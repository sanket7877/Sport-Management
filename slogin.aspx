<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slogin.aspx.cs" Inherits="SMS.login" %>
...
<form id="form1" class="login" runat="server">
     <div class="form-group">
          <h3>  <asp:Label ID="Label1" for="exampleInputEmail1" runat="server" Text="Login For Student"></asp:Label></h3>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <asp:LinkButton ID="LinkButton1" href="registration.aspx" runat="server" ForeColor="White">Create Account</asp:LinkButton>
</form> 
