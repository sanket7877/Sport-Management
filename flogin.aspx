<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flogin.aspx.cs" Inherits="SMS.flogin" %>
...
{
window.location = "first_page.aspx";
return false;
}
}
</script>
  ...
  <div class="form-group">
        <div class="form-group">
          <h3>  <asp:Label ID="Label1" for="exampleInputEmail1" runat="server" Text="Login For Faculty"></asp:Label></h3>
  </div>
  ...
  <div class="form-group">
    ...
    <asp:Button ID="submit"  runat="server" class="btn btn-primary" Text="Login" />
      <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="White">Create Account</asp:LinkButton>
</form> 
