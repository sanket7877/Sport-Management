<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Select_login.aspx.cs" Inherits="SMS.Select_login" %>
...
<marquee id="mar">WELCOME SPORTS WEEK 2K19</marquee>
  ...
  <form id="form1" runat="server" class="login">
       ...
       <asp:Label ID="Label6" for="exampleInputEmail1" runat="server" Text="Select Login Type"></asp:Label>
         <asp:DropDownList ID="DropDownList1" class="form-control" runat="server">
            ...
            <asp:ListItem>Admin</asp:ListItem>  
                  ...
                  <br />
            <asp:Button ID="Button1" runat="server"  class="btn btn-light bu" Text="Submit" />
    </div>
      </form
    >
